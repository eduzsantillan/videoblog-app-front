...
const UploadVideoBlog = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:9091/api/videoblog/create', requestOptions);
        ...
        <Header/>
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3" controlId="formBasicUrlVideo">
                    ...
                    <Form.Control type="text" placeholder="Enter youtube url" value={urlVideo} onChange={(e) => setUrlVideo(e.target.value)} />
                </Form.Group>
